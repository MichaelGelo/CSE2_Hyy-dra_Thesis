// config.h
// Configuration constants and file paths for the Levenshtein distance computation
...
#define PARTITION_THRESHOLD 1000000  // Minimum reference length to trigger partitioning
