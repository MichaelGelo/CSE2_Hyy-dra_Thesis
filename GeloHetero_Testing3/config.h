...
// ============================================================================
// FILE PATHS
// Direct paths to the single query and reference FASTA files
// ============================================================================

#define QUERY_FILE     "/home/dlsu-cse/Downloads/Testing2026/Testing/queries/que_256_1.fasta"
#define REFERENCE_FILE "/home/dlsu-cse/Downloads/Testing2026/Testing/ref_ratio/ref2M_15.fasta"
...
#define HOST_FPGA_REF_DIR   "/home/dlsu-cse/githubfiles/CSE2_Hyy-dra_Thesis/GeloHetero_Testing3/fpga_splits"
#define HOST_FPGA_QUERY_DIR "/home/dlsu-cse/githubfiles/CSE2_Hyy-dra_Thesis/GeloHetero_Testing3/fpga_splits"
...
// ============================================================================
#define GPU_SPEED_RATIO  0.90f         // Initial GPU workload ratio (0.0-1.0)
#define FPGA_SPEED_RATIO 0.10f          // Initial FPGA workload ratio (0.0-1.0)
...
#define RATIO_SMOOTHING_ALPHA 0.25f     // Adaptation speed (0=no change, 1=immediate) — lowered from 0.5 to reduce oscillation
#define RATIO_DEAD_BAND 0.03f           // Ignore adjustments when GPU/FPGA times are within 3% — prevents drift from timing noise

#define MIN_REF_LENGTH_FOR_FPGA 1000000 // References below this length run on GPU only (parallel chunks)
#define MAX_FPGA_REF_LENGTH 100000000    // Maximum reference length FPGA can handle (~130M chars)
